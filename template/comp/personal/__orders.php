<div class="orders">
    <div class="back-button-wrapper">
        ...
        <h1 class="content__title">Заказы</h1>
    </div>
    <div class="orders__wrap flex --just-space">
                            ...
                            <div class="order-history__sort-head pb-24 mt-48 flex --just-space">
                                <div class="order-history__sort-item col --2">
                                    <div class="catalog-filter__sort-value-wrap flex --align-center">
                                        ...
                                        <div class="catalog-filter__sort-icon --desc --svg__filter-sort"></div>
                                    </div>
                                </div>
                                <div class="order-history__sort-item col --2">
                                    <div class="catalog-filter__sort-value-wrap flex --align-center">
                                ...
                                <? for ($d=0; $d < 3; $d++) { ?>
                                    <div class="order-history-item">
                                        <div class="order-history-item__head flex --just-space --align-center py-32">
                                            ...
                                            <div class="order-history-item__divider"></div>
                                            ...
                                            <div class="order-history-item__items">
                                                        ...
                                                        <div class="cart-item__info col --auto">
                                                            <div class="cart-item__head">
                                                                ...
                                                                <div class="cart-item__props mt-8 flex">
                                                                    <div class="cart-item__prop mr-16 p --m">Серия: <b>714203</b></div>
                                                                    <div class="cart-item__prop p --m">Вес: <b>Вес: 25 г</b></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="order-history-item__item">
                                                    <div class="cart-item py-40 flex">
                                                        <a href="#" class="cart-item__tumb flex --just-center mr-32">
                                                            <picture class="lazy">
                                                                <source srcset="/template/dist/img/wheel-gr1.webp" type="image/webp">
                                                                <img src="/template/img/wheel-gr1.png" alt="Техника для склада">
                                                            </picture>
