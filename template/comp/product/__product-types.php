<?php
    if (empty($productTypeTitle)) {
        $productTypeTitle = 'Рекомендуем к покупке';
    }
?>

<div class="product-carousel">
    <div class="center-wrap">
        <div class="js-product-slider-wrapper type-carusel product-types">
            <div class="type-carusel__head flex --align-center --just-space mb-32">
                <div class="type-carusel__title h3"><?php echo $productTypeTitle ?></div>
                <div class="type-carusel__nav flex --align-center">
                    <div class="js-product-slider-btn-prev type-carusel__btn --left swiper-button-prev"></div>
                    <div class="type-carusel__pagination mx-16">
                        <div class="js-product-slider-pagination swiper-pagination"></div>
                    </div>
                    <div class="js-product-slider-btn-next type-carusel__btn --right swiper-button-next"></div>
                    <div>
                        <a class="product-types__button btn --dark ml-16" href="#">
                            <span>Показать</span> все</a>
                    </div>
                </div>
            </div>
