$(document).ready(function () {
    ...
    $('.filter-item .checkbox input').on('change', function(){
        ...
        $(this).parents('.filter-item').find('.filter-item__name-value').text(filter_name)
        getValues();
        filter();
	});
    ...
    $('.tooltip__clear-btn').on('click', function(){
        ...
        $(this).parents('.filter-item').find('.filter-item__count-label').text('Не выбрано');
        $(this).parents('.filter-item').find('.filter-item__name-value').text('Выбрать');
        getValues();
        filter();
