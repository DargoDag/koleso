<div class="product-carousel --interest">
    <div class="center-wrap">
        <div class="type-carusel js-swiper__products">
            <div class="type-carusel__head flex --align-center --just-space mb-32">
                <div class="type-carusel__title h3">Для комплекта вам может понадобиться:</div>
