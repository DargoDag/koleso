<div class="auth col --4">
    <div class="auth__head">
        ...
        <p class="auth__post-title p --l mt-16">Войдите в личный кабинет, используя электронную почту и пароль, или <a href="#" class="link --color-dark"><b>зарегистрируйтесь</b></a></p>
    </div>
    ...
    <form action="#" class="auth__form 32">
        <div class="auth__form-line mt-12">
            <div class="big-input --no-radius --no-border">
                ...
                <div class="big-input__title">Электронная почта</div>
            </div>
        </div>
        <div class="auth__form-line mt-12">
