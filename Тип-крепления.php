...
<div class="content page-content">
    ...
    <div class="js-filter-sticky-helper content__wrap center-wrap wheel-weight mt-48">
        <?php include($_SERVER['DOCUMENT_ROOT'].'/template/comp/wheel-types/__wheel-types.php'); ?>
        <?php include($_SERVER['DOCUMENT_ROOT'].'/template/comp/mount-type/__mount-type.php'); ?>
