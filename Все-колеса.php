...
<div class="content page-content">
    ...
    <div class="back-button-wrapper center-wrap">
    ...
    <div class="js-filter-sticky-helper content__wrap center-wrap mt-48">
        <?php include($_SERVER['DOCUMENT_ROOT'] . '/template/comp/wheel-types/__wheel-types.php'); ?>
        <?php include($_SERVER['DOCUMENT_ROOT'] . '/template/comp/wheels/__wheels.php'); ?>
